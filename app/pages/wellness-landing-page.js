...
function buildPageContent() {
    ...
    var awardsStack         = page.getViewById("awardsStackControl");
    var eapStack            = page.getViewById("eapStackControl");
    var videosStack         = page.getViewById("videosStackControl");

    publicServicesStack.removeChildren();
    awardsStack.removeChildren();
    eapStack.removeChildren();
    videosStack.removeChildren();
    ...
    contactsAndResources.forEach( function(newsletter) {
        ...
        eapSelection.addEventListener( "tap" , (newsletter.Category == "Videos" ? goToVideos : loadNewsletter) , { contents: (currentLanguage=="French" ? newsletter.ContentFR : newsletter.ContentEN), title: (currentLanguage=="French" ? newsletter.TitleFR : newsletter.TitleEN) });
        
        switch( newsletter.Category ) {
            case "Videos":
                videosStack.addChild(eapSelection);
                break;
            case "EAPNewsletter":
            ...
            case "Services":
                ...
                break;
            case "Awards":
                awardsStack.addChild(eapSelection);
                break;
        }
    });
};
