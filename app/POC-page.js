...
var doBrowse = function(event) {
    console.log( "doPhoneCall " + event.object.phoneNumber );
    phone.dial(event.object.phoneNumber,true);
};
...
var getFromDatabase = function(){
    ...
    databaseReturn.push(dbRow);
    dbRow = {Ref:24, TitleEN:`Great-West Life - Public Service Dental Care Plan`, TitleFR:`La Great-West - Régime de soins dentaires de la fonction publique `, ContentEN:`<*Article_H1*>Great-West Life - Public Service Dental Care Plan<*Article_Body*>::contact::1-855-415-4414||tel:1-855-415-4414::contact::`, ContentFR:`<*Article_H1*>La Great-West - Régime de soins dentaires de la fonction publique <*Article_Body*>::contact::1-855-415-4414||tel:1-855-415-4414::contact::`};
    databaseReturn.push(dbRow);
