...
var getFromDatabase = function(){
    ...
    databaseReturn.push(dbRow);
    dbRow = {Ref:3, TitleEN:`Section 34 Manager Support Line`, TitleFR:`Article 34 Ligne de soutien à l'intention des gestionnaires`, ContentEN:`<*Article_H1*>Section 34 Manager Support Line<*Article_Body*>If you are a Section 34 Manager experiencing issues with pay approval related tasks, a representative from HR Connect RH can help resolve your issues.::contact::1-833-747-6363||tel:1-833-747-6363::contact::`, ContentFR:`<*Article_H1*>Article 34 Ligne de soutien à l'intention des gestionnaires<*Article_Body*>Si vous êtes un gestionnaire de l'article 34 et que vous éprouvez des problèmes avec les tâches liées à l'approbation de la paye, un représentant de HR Connect RH peut vous aider à résoudre vos problèmes.::contact::1-833-747-6363||tel:1-833-747-6363::contact::`};
    databaseReturn.push(dbRow);
