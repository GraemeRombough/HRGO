...
var displayPOCs = function(SJDs){
    ...
    for(i = 0; i < SJDs.length; i++ ){
        SJDList.addChild(createSJDGrid(SJDs[i].Title, SJDs[i].Salary, SJDs[i].Classification, SJDs[i].Desc));
    }
};
var createSJDGrid = function(SJD_t, SJD_s, SJD_c, SJD_d){
